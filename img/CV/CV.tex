...
Sebastiano Panichella is a passionate  Computer Science Researcher at the University of Bern (UniBe), leading research in  Software Engineering (SE), cloud computing (CC), and Data Science (DS) research fields. \\
...
\vspace{-1.5mm}
  ...
  \item The research proposal submitted to the Innosuisse called ``ARIES: Exploiting User Journeys and Testing Automation for Supporting Efficient Energy Service Platforms" was selected for funding in 2021.
   \item The research proposal submitted to the SNSF called ``SwarmOps: Human-sensing based MLOps for Collaborative Cyber-physical systems" was selected for funding in 2023.
  \item The research proposal submitted to the Hasler Foundation called ``"Bridging the Reality Gap in Testing Unmanned Aerial Vehicles"  was selected for funding in 2023.
   \item The research proposal entitled ``InnoGuard: Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems" and submitted to Horizon EU Call ``Marie Sklodowska-Curie Actions-funded Doctoral Networks" was selected for funding in 2023.
\vspace{-1.5mm}
...
\textbf{Cyber-physical systems (CPSs) development}. Much of the increasing complexity of ICT systems is being driven by the more distributed and heterogeneous nature of these systems, with Cyber-Physical Systems accounting for an increasing portion of Software Ecosystems. This basic premise underpins the research conducted by Dr. Panichella in the COSMOS H2020 and the ARIES Innosuisse projects, which focuses on blending best practices DevOps solutions with the development processes used in the CPS context: this will enable the CPS world to deliver software more rapidly and result in more secure and trustworthy systems. COSMOS brings together a balanced consortium of big industry, SMEs and academics which will develop enhanced DevOps pipelines which target development of CPS software. The COSMOS CPS pipelines will be validated against several use cases provided by industrial partners representing healthcare, avionics, automotive, micromobility, utility and railway sectors. These will act as reference use cases when promoting the technology amongst Open Source and standardization communities. \\
    More information about the COSMOS H2020 project can be found at \\\url{https://www.cosmos-devops.org/}. \\Information on the ARIES project can be found at \\\url{https://aries-devops.ch/}.\\\\Information on some of the papers accepted on the projects \\(\url{https://spanichella.github.io/publications.html}): \ref{J22}\ref{J21}\ref{J20}\ref{J18}\ref{J17}, \ref{Cm24}\\\\
...
Empirical software engineering is a sub-domain of software engineering focusing on experiments on software systems (software products, processes, and resources). It is interested in devising experiments on software, in collecting data from these experiments, and in devising laws and theories from this data. Proponents of experimental software engineering advocate that the nature of software is such that we can advance the knowledge on software through experiments only. The scientific method suggests a cycle of observations, laws, and theories to advance science. Empirical software engineering applies this method to software.
   ...
   safety in cyber-physical systems development \ref{J20} \ref{J18}. Information on the papers accepted on related projects \\(\url{https://spanichella.github.io/publications.html})
   \\
...
Software repositories such as source control systems, archived communications between project personnel, and defect tracking systems are used to help manage the progress of software projects. Software practitioners and researchers are recognizing the benefits of mining this information to support the maintenance of software systems, improve software design/reuse, and empirically validate novel ideas and techniques. Research is now proceeding to uncover the ways in which mining these repositories can help to understand software development and software evolution, to support predictions about software development, and to exploit this knowledge concretely in planning future development. The Mining Software Repositories (MSR) field analyzes the rich data available in software repositories to uncover interesting and actionable information about software systems and projects.
   ...
   More in general, Dr. Panichella is interested to conceive tools to support developers in evolving modern software applications  \ref{J20} \ref{J18}.  Information on the papers accepted on related projects \\(\url{https://spanichella.github.io/publications.html}) 
. \\
...
\begin{bibenum}
\item \label{J27} Christian Birchler, Sajad Khatiri, Pooja Rani, Timo Kehrer, Sebastiano Panichella: \textbf{A Roadmap for Simulation-Based Testing of Autonomous Cyber-Physical Systems: Challenges and Future Direction}.    Special issue "A 2030 Roadmap for Software Engineering" in ACM Transactions on Software Engineering and Methodology (TOSEM 2025). 
\item \label{J26} Sajad Khatiri, Andrea Di Sorbo, Fiorella Zampetti, Corrado A. Visaggio, Massimiliano Di Penta, \underline{Sebastiano Panichella}: \textbf{Identifying Safety-Critical Concerns in Unmanned Aerial Vehicle Software Platforms with SALIENT}. SoftwareX Journal, 2024. 
\item \label{J25} Pooja Rani, Arianna Blasi, Nataliia Stulova, \underline{Sebastiano Panichella}, Alessandra Gorla, Oscar Nierstrasz: \textbf{A Decade of Code Comment Quality Assessment: A Systematic Literature Review}.    Journal of Systems \& Software (JSS).  
\item \label{J24} Xavier Devroey, Alessio Gambi, Juan Pablo Galeotti, Rene Just, Fitsum Kifetew, Annibale Panichella, and \underline{Sebastiano Panichella}: \textbf{JUGE: An Infrastructure for Benchmarking Java Unit Test Generators}.    Software Testing, Verification and Reliability.  
\item \label{J23} Christian Birchler, Sajad Khatiri, Bill Bosshard, Alessio Gambi, \underline{Sebastiano Panichella}: Machine Learning-based Test Selection for Simulation-based Testing of Self-driving Cars Software. Empirical Software Engineering.
\item \label{J22} Christian Birchler, Nicolas Ganz, Sajad Khatiri, Alessio Gambi,  \underline{Sebastiano Panichella}: Cost-effective Simulation-based Test Selection in Self-driving Cars Software. Science of Computer Programming. 

\item \label{J21} Andrea Di Sorbo, Fiorella Zampetti, Corrado A. Visaggio, Massimiliano Di Penta, \underline{Sebastiano Panichella}: Automated Identification and Qualitative Characterization of Safety Concerns Reported in UAV Software Platforms.    Transactions on Software Engineering and Methodology (TOSEM)

\item \label{J20} Zampetti, Fiorella; Tamburri, Damian ; \underline{Sebastiano Panichella}; Panichella, Annibale; Canfora, Gerardo; Di Penta, Massimiliano:    Continuous Integration and Delivery practices for Cyber-Physical systems: An interview-based study.  Transactions on Software Engineering and Methodology (TOSEM)
\item \label{J19} Annibale Panichella, \underline{Sebastiano Panichella}, Gordon Fraser, Anand Sawant, and Vincent Hellendoorn: Test Smells 20 Years Later: Detectability, Validity, and Reliability.    Empirical Software Engineering (EMSE) Journal.
\item \label{J18} Fiorella Zampetti, Ritu Kapur, Massimiliano Di Penta,  \underline{Sebastiano Panichella}, An Empirical Characterization of Software Bugs in Open-Source Cyber-Physical Systems.    Journal of Systems and Software (JSS).
...
\textbf{\\\underline{Conference/Workshop Publications after the Ph.D.:}}\\
\begin{bibenum}
 %\textit{Core RANK: B}.
 \item \label{Cm30} Christian Birchler, Tanzil Kombarabettu Mohammed, Pooja Rani, Teodora Nechita, Timo Kehrer, \underline{Sebastiano Panichella}: \textbf{How does Simulation-based Testing for Self-driving Cars match Human Perception?}. ACM International Conference on the Foundations of Software Engineering (FSE 2024)
   		\item \label{Cm32} Nicolas Erni, Al-Ameen, Mohammed, Christian Birchler, Pouria Derakhshanfar, Stephan Lukasczyk, \underline{Sebastiano Panichella}: \textbf{ SBFT Tool Competition 2024 -- Python Test Case Generation Track}. 17th International Workshop on Search-Based and Fuzz Testing (SBFT) 2024. 
   		\item \label{Cm31} Sajad Khatiri, Prasun Saurabh, Timothy Zimmermann, Charith Munasinghe, Christian Birchler, \underline{Sebastiano Panichella}: \textbf{SBFT Tool Competition 2024 - CPS-UAV Test Case Generation Track}. 17th International Workshop on Search-Based and Fuzz Testing (SBFT) 2024.  
   		\item \label{Cm29}  Timo Blattner, Christian Birchler, Timo Kehrer, \underline{Sebastiano Panichella}: \textbf{Diversity-guided Search Exploration for Self-driving Cars Test Generation through Frenet Space Encoding}. Intl. Workshop on Search-Based and Fuzz Testing (SBFT). 2024
   		\item \label{Cm28} Christian Birchler, Cyrill Rohrbach, Timo Kehrer, \underline{Sebastiano Panichella}: \textbf{SensoDat: Simulation-based Sensor Dataset of Self-driving Cars}. Mining Software Repositories (MSR). 2024
   		\item \label{Cm27} Sajad Khatiri, \underline{Sebastiano Panichella}, Paolo Tonella: \textbf{Simulation-based Testing of Unmanned Aerial Vehicles with Aerialist}.        International Conference on Software Engineering. 2024.
...
Awards as Reviewer:
\begin{enumerate}
\item \textbf{Distinguished Reviewer at TSE 2023}.
\item \textbf{Distinguished Reviewer Award MSR 2022}
 ...
 \item \label{Cm3}  G. Grano, A. Ciurumelea, \underline{S. Panichella}, F. Palomba, H. Gall. \textbf{ Exploring the Integration of User Feedback in Automated Testing of Android Applications.}.  \emph{Proceedings of the  {IEEE} 25th International Conference on Software Analysis, Evolution
      ...
      \item \label{Cm2}  C. Vassallo, \underline{S. Panichella}, F. Palomba, S. Proksch, A. Zaidman and H. Gall. \textbf{Context is King: The Developer Perspective on the Usage of Static Analysis Tools.}.  \emph{Proceedings of the  {IEEE} 25th International Conference on Software Analysis, Evolution
               and Reengineering}  (SANER 2018) 
                ...
                \item  \label{Cm2_2}   C. Alexandru,  \underline{S. Panichella}, Harald Gall. \textbf{Reducing Redundancies in Multi-Revision Code Analysis}. In: \emph{24th IEEE International Conference on Software Analysis, Evolution, and Reengineering  (SANER) 2017. Klagenfurt, Austria}.  \textit{Core RANK: B}.
...
\begin{innerlist}
\item Main (UniBe) PI of the ``Marie Sklodowska-Curie Actions-funded Doctoral Networks" Horizon EU project project ``InnoGuard: Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems" and submitted to Horizon EU Call   
\item Main PI of the "SNSF" project ``SwarmOps: Human-sensing based MLOps for Collaborative Cyber-physical systems"  
\item Main PI of the ``Hasler Foundation" project "Bridging the Reality Gap in Testing Unmanned Aerial Vehicles"  
...
\item Technical coordinator of the Innosuisse project ``ARIES: Exploiting User Journeys and Testing Automation for Supporting Efficient Energy Service Platforms"   (recently selected for funding) \\
	\end{innerlist}
...
\item Chair of the \textit{Workshop on Natural Language-Based Software Engineering Workshop} (NLBSE) - Collocated with ICSE 2022, 2023.
\item Chair of  the \textit{Workshop on Search-Based Software Testing} (SBST) - Collocated with ICSE 2022, 2023, 2024, 2025
...
\begin{innerlist}
\item Program Committee member of the International Conference on Software Engineering - (ICSE 2025, 2024, 2023, 2022, 2018)
...
\item Program Committee member of  the IEEE Conference on Software Testing, Validation and Verification (ICST 2024, 2022, 2020) 
\item Program Committee member of  International Conference on Software Maintenance and Evolution (ICSME 2024, 2023, 2022, 2018, 2017). 
\item Program Committee member of the  International Conference on Software and Data Technologies (2021)
\item Program Committee member of the International Conference on Program Comprehension (ICPC 2023, 2022, ICPC 2020, 2017, 2016, 2015, 2014).
\item Program Committee member of  the International Conference on Mining Software Repositories (MSR 2024, 2022, 2020, 2019, 2018, 2016)  
...
\item \emph{Software: Practice and Experience journal}
\item \emph{Communications of the ACM}\\
\end{innerlist} 
...
\begin{innerlist}
\item  \emph{Sebastiano Panichella led a Shonnan meeting with the National Institute of Informatics (NII), Japan, on the topic: ``DevOps for Cyber-physical Systems"}. 
...
\textbf{EU projects}
\begin{innerlist}
\item Sebastiano Panichella got funding (as main research responsible at UniBe) from the Horizon EU Call "Marie Sklodowska-Curie Actions-funded Doctoral Networks" for the project "InnoGuard: Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems".
...
\textbf{Talks Given is detailed at https://spanichella.github.io/services.html}
...
\begin{bibsection}
\item \textbf{Pablo Valenzuela, PhD student at University of Bern}, Switzerland (from 2024).\\
...
\textit{-  Special issue "A 2030 Roadmap for Software Engineering" in ACM Transactions on Software Engineering and Methodology (TOSEM 2025). }\\
\textit{- SBFT Tool Competition 2024 - CPS-UAV Test Case Generation Track. 17th International Workshop on Search-Based and Fuzz Testing. 2024 }\\
\textit{- Simulation-based Testing of Unmanned Aerial Vehicles with Aerialist. International Conference on Software Engineering. 2024}\\
\textit{- Simulation-based Test Case Generation for Unmanned Aerial Vehicles in the Neighborhood of Real Flights. International Conference on Software Testing, Verification and Validation.}\\
\textit{- Machine Learning-based Test Selection for Simulation-based Testing of Self-driving Cars Software". Empirical Software Engineering.}\\
...
\item \textbf{Pooja Rani, PhD student at University of Bern, Switzeerland. }\\
 ...
 \textit{- Best PhD Thesis Award: Congratulations to Pooja Rani on receiving an award at the University of Bern for her Ph.D. thesis entitled "Assessing Comment Quality in Object-Oriented Languages"}\\
   \textit{- A Decade of Code Comment Quality Assessment: A Systematic Literature Review}. Journal of Systems \& Software (JSS), 2022.\\
...
\textit{-  Special issue "A 2030 Roadmap for Software Engineering" in ACM Transactions on Software Engineering and Methodology (TOSEM 2025). }\\
\textit{- SBFT Tool Competition 2024 -- Python Test Case Generation Track 17th International Workshop on Search-Based and Fuzz Testing (SBFT 2024)}\\ 
\textit{- How does Simulation-based Testing for Self-driving Cars match Human Perception? ACM International Conference on the Foundations of Software Engineering (FSE 2024).}\\ 
\textit{- Diversity-guided Search Exploration for Self-driving Cars Test Generation through Frenet Space Encoding. Intl. Workshop on Search-Based and Fuzz Testing (SBFT). 2024}\\
\textit{- SensoDat: Simulation-based Sensor Dataset of Self-driving Cars. Mining Software Repositories (MSR) conference. 2024}\\
\textit{- TEASER: Simulation-based CAN Bus Regression Testing for Self-driving Cars Software. International Conference on Automated Software Engineering.}\\
\textit{- Machine Learning-based Test Selection for Simulation-based Testing of Self-driving Cars Software". Empirical Software Engineering.}\\
\textit{- Cost-effective Simulation-based Test Selection in Self-driving Cars Software. Science of Computer Programming. 2022.}\\
\textit{- Single and Multi-objective Test Cases Prioritization for Self-driving Cars in Virtual Environments. ACM Transactions on Software Engineering and Methodology (TOSEM). 2022.}\\
\textit{- Cost-effective Simulation-based Test Selection inSelf-driving Cars Software with SDC-Scissor.  SANER 2022}. 
...
\textit{- How does Simulation-based Testing for Self-driving Carsmatch Human Perception? ACM International Conference on the Foundations of Software Engineering (FSE 2024).}\\ 

\item \textbf{Prasun Saurabh, Research assistant at Zurich University of Applied Sciences}, Switzerland (from 2023-06 to Present). \\
...
- SBFT Tool Competition 2024 - CPS-UAV Test Case Generation Track. 17th International Workshop on Search-Based and Fuzz Testing. 2024 

\item \textbf{Susana Soriano, Research assistant at Zurich University of Applied Sciences}, Switzerland (from 2023-06 to Present). \\
- Working on the Innosuisse ARIES project (Exploiting User Journeys and Testing Automation for Supporting Efficient Energy Service Platforms).\\ 

\item \textbf{Al-Ameen Mohammed Ali Mohammed, Research assistant at Zurich University of Applied Sciences}, Switzerland (from 2023-06 to Present). \\
- Working on the Innosuisse ARIES project (Exploiting User Journeys and Testing Automation for Supporting Efficient Energy Service Platforms).\\ 
\textit{- SBFT Tool Competition 2024 -- Python Test Case Generation Track 17th International Workshop on Search-Based and Fuzz Testing (SBFT 2024)}\\ 
...
\item \textbf{Julian Mauerhofer, Master student at University of Bern, Switzerland, 2024/2025}\\
\item  \textbf{Timo Blattner, Master student at University of Bern, Switzerland. 2024}\\
\textit{- Diversity-guided Search Exploration for Self-driving Cars Test Generation through Frenet Space Encoding. Intl. Workshop on Search-Based and Fuzz Testing (SBFT)}
\item  \textbf{Marco De Liso, Master student at University of Bern, Switzerland. 2023-2024.}
\item  \textbf{Maria Asad, Master student at University of Bern, Switzerland. 2022-2023.}
\item  \textbf{Cyrill Rohrbach, Master student at University of Bern, Switzerland. 2022-2023.}\\
\textit{- SensoDat: Simulation-based Sensor Dataset of Self-driving Cars. Mining Software Repositories (MSR) conference. 2024}\\
\textit{- TEASER: Simulation-based CAN Bus Regression Testing for Self-driving Cars Software. International Conference on Automated Software Engineering.} 2023\\
\item  \textbf{Hyeongkyun Kim, Master student at University of Zurich, Switzerland. 2021-2023.}\\
\textit{- TEASER: Simulation-based CAN Bus Regression Testing for Self-driving Cars Software. International Conference on Automated Software Engineering.}\\

\item  \textbf{Prasun Saurabh, Master student at University of Zurich, Switzerland. 2022.}\\
- Development and security-testing tools for Cyber-physical systems
\item  \textbf{ Nicolas Erni, Master student at Zurich University of Applied Sciences, Switzerland.}\\
- Testing tools for Cyber-physical systems (Efficient Energy Service Platforms) 
\item  \textbf{ Abdlrahman Essa, Master student at University of Zurich, Switzerland.}\\
- Development and testing tools for Cyber-physical systems 
\item  \textbf{Andrius Kirilovas, Master student at University of Zurich, Switzerland.}\\
- Development and testing tools for Cyber-physical systems
\item  \textbf{ Tanzil Kombarabettu Mohammed, Master student at University of Zurich, Switzerland. 2022.}\\
\textit{- How does Simulation-based Testing for Self-driving Carsmatch Human Perception? ACM International Conference on the Foundations of Software Engineering (FSE 2024).}\\ 

\item  \textbf{Gabriela Lopez, Master student at University of Zurich, Switzerland. }\\
...
\item \textbf{Rafael Kallis, Master student at University of Zurich, Switzerland, 2019}.\\
                 ...
                 \textit{- NLBSE’22 Tool Competition.    2022 IEEE/ACM 1st International Workshop on Natural Language-Based Software Engineering} (NLBSE 2022). \\
...
\item \textbf{William Anze Dan, bachelor student at University of Bern, Switzerland}, 2024/2025.
\item \textbf{Vsevolod Yevdokimov, bachelor student at University of Bern, Switzerland}, 2024/2025.
...
\section{Professional Memberships}
    ...
    \item Member to represent the \textbf{COST Action CA22137 in Switzerland. Member of the COST (European Cooperation in Science and Technology)}: WG4 on "Optimisation under uncertainty" - https://www.cost.eu/actions/CA22137/
    \item Member of the \textbf{EU Sparc Robotics group} - https://sparc-robotics-portal.eu
    \item Member of the \textbf{ZHAW Digital Futures Lab} - https://www.zhaw.ch/en/focus-topics/zhaw-digital/digital-futures-lab/ 2023/2024
    \end{innerlist}
...
\textbf{Denys Poshyvanyk, Ph.D}
(e-mail: \href{mailto:denys@cs.wm.edu}{denys@cs.wm.edu}) 
%
\begin{innerlist}
    \item Professor,
        \href{}{Wayne State University}
\end{innerlist}
...
\begin{innerlist}
    \item Senior Researcher,
        \href{}{Zurich University of Applied Sciences}

    \item[$\star$] \emph{Dr.~Murphy, close colleague at the Zurich University of Applied Sciences.}
\end{innerlist}
