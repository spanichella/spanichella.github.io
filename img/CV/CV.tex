...
Sebastiano Panichella is a passionate  Computer Science Researcher (permanent position) at Zurich University of Applied Sciences (ZHAW), leading research in  Software Engineering (SE), cloud computing (CC), and Data Science (DS) research fields. \\
...
%\textit{E-mail:} \email{spanichella@gmail.com}\\
%\textit{Home Page:} \href{http://www.ing.unisannio.it/spanichella}{www.ing.unisannio.it/spanichella}
\textit{Address:} \href{https://www.zhaw.ch/en/engineering/}{Zurich University of Applied Sciences (ZHAW)}\\ 
...
\begin{innerlist}
\item Main (ZHAW) PI of the ``Marie Sklodowska-Curie Actions-funded Doctoral Networks" Horizon EU project project ``InnoGuard: Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems" and submitted to Horizon EU Call   
