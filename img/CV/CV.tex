...
\textit{Address 1:} \href{}{The Italian Institute of Artificial Intelligence for Industry (AI4I)}\\ 
Corso Castelfidardo, 22, 10129 Torino TO, Italy
\\ 
\textit{Address 2:} \href{}{University of Bern (UniBe)}\\ 
Schützenmattstrasse 14, 3012 Bern, Switzerland.\\ 
%\textit{Tel.: +39 0824 305539} \\
%\textit{Tel.: +41 (0) 58 934 41 56} \\
\textit{E-mail:} \email{sebastiano.panichella@ai4i.it}, \email{sebastiano.panichella@unibe.ch},  \email{spanichella@gmail.com}\\
...
Currently, he is a Senior Computer Science Researcher at the University of Bern (from \textit{\textbf{09-2024}}) and Head of the IDeaLS Lab (Intelligent Development and Large-Scale Systems Lab) at the Italian Institute of Artificial Intelligence for Industry (at AI4I, from \textit{\textbf{02-2026}}). 
Previously he was a Senior Computer Science Researcher and Lecturer in Software Engineering at ZHAW (from 08-2018 to 08-2024), a postdoctoral researcher at the University of Zurich (\textbf{2014-11-01 - 2018-08-19}) in the lab of Prof. Harald C. Gall, and part-time (External) Lecturer at the University of Zurich (between \textit{\textbf{2018-2022}}). He received his PhD in Computer Science from the University of Sannio (Department of Engineering) in 2014, defending the thesis entitled ``Supporting Newcomers in Open Source Software Development Projects''.

His main \textbf{research goal} is to conduct industrial research, involving both industrial and academic collaborations, to sustain the Internet of Things (IoT) vision, where future ``smart cities'' will be characterized by millions of smart systems and AI-enabled systems (e.g., cyber-physical systems such as drones and other autonomous intelligent systems) connected over the Internet, composed of AI components and/or controlled by complex embedded software implemented for the cloud.
...
His \textbf{research interests}\footnote{Research interests detailed here \url{https://spanichella.github.io/research_interests.html}} span Software Engineering (SE), Cloud Computing (CC), Data Science (DS), and Life Engineering (LE), including:
DevOps (Continuous Delivery and Continuous Integration), MLOps, Machine Learning applied to SE, Software Maintenance and Evolution (with particular focus on Cloud, mobile, AI-based, and Cyber-physical systems), Mining Software Repositories, Mobile Computing, Human-Computer Interaction, and Summarization Techniques for Code, Changes, and Testing.

He authored or co-authored \textbf{more than one hundred} papers (including demonstration, dataset, and poster papers) published in international conferences and journals (26 of them during his postdoctoral experience at the University of Zurich). Several of these works involved industrial collaborations and received best paper awards or nominations.

\medskip
\noindent
\textbf{Scientific Recognition and Rankings.}
Dr. Panichella was selected in 2019 as one of the top-20 (second in Switzerland) Most Active Early Stage Researchers Worldwide in Software Engineering (reported by the Journal of Systems and Software). In 2021, he was selected as one of the top-20 Most Impactful Software Engineering researchers worldwide (JSS results). 

According to the Stanford University ranking in the article ``A standardized citation metrics author database annotated for scientific field'' (September 2022 data update), he appears in the top 2\% worldwide in his sub-field. The same distinction was confirmed in the 2023 and 2025 updates (``Updated science-wide author databases of standardized citation indicators''). 

ScholarGPS ranked him in the top 0.5\% of scholars worldwide in 2024 and 2025 based on scholarly impact and quality of contributions.

\medskip
\noindent
\textbf{Awards.}
He received the Most Influential Paper (MIP) Award at ICSME 2025 for the paper ``How Can I Improve My App? Classifying User Reviews for Software Maintenance and Evolution'' (ICSME 2015), which has accumulated around 600 citations and is among the most cited papers of the conference. 
In 2025, he also received the Most Influential 5-Years Journal Paper Award on Software Testing at ICST for the paper ``How Developers Engage with Static Analysis Tools in Different Contexts'' (Empirical Software Engineering).

\medskip
\noindent
\textbf{Supervision and Academic Service.}
He has supervised or co-supervised 19 undergraduate students, 27 MSc students, 17 PhD students (6 during his postdoctoral experience at the University of Zurich), 2 postdoctoral researchers, and 11 research assistants. 
He serves or has served as program committee member for major international conferences including ICSE, ICST, ISSTA, ASE, FSE, and ICSME. 
He is an Editorial Board Member of the Journal of Software: Evolution and Process (JSEP) and ACM Transactions on Software Engineering and Methodology (TOSEM), and a distinguished reviewer for TOSEM.

\medskip
\noindent
\textbf{Funding Achievements.}
Over the last decade, he has secured competitive research funding exceeding 3,500,000 CHF as Principal Investigator (PI) or co-PI. His research has been funded by major national and international agencies, including:

\begin{itemize}
\item European Commission (H2020): COSMOS – DevOps for Complex Cyber-physical Systems (2020–2024).
\item Swiss National Science Foundation (SNSF): SURF-MobileAppsData (since 2021).
\item Innosuisse: ARIES – Exploiting User Journeys and Testing Automation for Supporting Efficient Energy Service Platforms (2020–2023).
\item Hasler Foundation: Bridging the Reality Gap in Testing Unmanned Aerial Vehicles (2024–2025).
\item Hasler Foundation: Advancing Unmanned Aerial Vehicles Reliability and Societal Trust Through Integrated Testing and Formal Verification (since 2025).
\item Swiss National Science Foundation: SwarmOps – Human-Sensing-based MLOps for Collaborative Cyber-physical Systems (since 2025).
\item Horizon Europe (Marie Skłodowska-Curie Doctoral Networks): InnoGuard – Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems (since 2024).
\item Innosuisse interdisciplinary project in biopharmaceutical R\&D, AI/ML, and Software Engineering (from 2025).
\end{itemize}

The paper ``How can I improve my app? Classifying user reviews for software maintenance and evolution'' (ICSME 2015) originated the idea behind his first SNSF-funded project and remains one of the most cited papers of the conference.
...
\item A. Prakash, \underline{S. Panichella}: Physics-Informed Machine Learning for Precision Unmanned Aerial Vehicle Control: Adaptive Transformers with Safety Guarantees. Engineering Applications of Artificial Intelligence Journal. 2026 
...
\medskip \\
- Lecturer of new course ``DevOps for Cyber-Physical Systems'' (interdisciplinary between Robotics, AI, and Software Engineering) –  Spring 2026.\\
- Lecturer of new interdisciplinary course ``Autonomous Systems in Practice: Technology, Law, and Society'' (in collaboration with Tobias Eule) –  Spring 2026.\\
...
\begin{innerlist}
   \item External examinator of Ph.D. Dissertation   by Baharin Aliashrafi Jodat at at University of Ottawa (2026). 
...
\begin{innerlist}
 \item \href{https://spanichella.github.io/services.html}{\textit{Program Committee member}} of ISSTA, ICSE, FSE, ASE, ICSME, ICST, ICSOFT, SSBSE, ICPC, NLBSE, SBFT, SBST, SANER, MSR, WAISE, MaLTeSQuE, SEAA, SATToSE, VST, RoSE, QUATIC, ISSTA, and many others. 
