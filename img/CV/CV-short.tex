...
Sebastiano Panichella got funding (as main research responsible at UniBe) from the Horizon EU Call ``Marie Sklodowska-Curie Actions-funded Doctoral Networks" for the project ``InnoGuard: Hybrid and Generative Intelligence for Trustworthy Autonomous Cyber-Physical Systems".
...
%Web page: \href{https://www.cosmos-devops.org/}{https://www.cosmos-devops.org/}
...
\textbf{Total project funding: direct funding for around \textbf{500,000 CHF}}. Web page: \href{https://spanichella.github.io/projects/aries-devops/index.html}{https://spanichella.github.io/projects/aries-devops/index.html}
%\textbf{Ack:} We personally thank the team of BOND for the very productive and constant research meetings. 
\end{innerlist}
\medskip 
\textbf{ Doctoral Grants \& Other Funding:}
\begin{innerlist}
...
\textbf{Total project 114,000 CHF}. 
  \item Sebastiano Panichella got funding (as main research responsible) for a Hasler Foundation Project. The funding will support and complement the studies of a Ph.D. student working "Testing Unmanned Aerial Vehicles" in the context of the COSMOS H2020 project (contract no. 957254).
...
\medskip \\
%\vspace{-5mm}
He \textbf{supervised} 14 theses of undergrad students, theses (or projects) of 22 MSc students and has \textbf{supervised (or co-supervised)} the work of 8 research assistants, and 9 PhD students (6 of them during the postdoctoral experience at the University of Zurich), which published in relevant conference and journal venues. A complete list on advised researchers and papers accepted can be found at
\href{https://spanichella.github.io/teaching\_and\_advising.html}{https://spanichella.github.io/teaching\_and\_advising.html}
\medskip \\%\medskip 
...
\textbf{Ability to receive funding as PI and co-PI on topics concerning his research interests\footnote{\url{https://spanichella.github.io/research\_interests.html}}}
\vspace{-2.5mm}
\begin{itemize}
...
\begin{itemize}
 %\vspace{-1.5mm}
  \item \textbf{Award}: He received 4 tools awards (and nominations) as well as 12 best paper awards and best paper nominations\footnote{\url{https://spanichella.github.io/awards.html}}.
   \vspace{-2mm}
  ...
  \vspace{-2mm}
   \item \textbf{Collaboration with industrial organizations:} Over the years, He established collaboration with several researchers from Switzerland (UZH, USI, ZHAW, ETH, etc.) and abroad involving both academic and industrial organizations: \url{https://spanichella.github.io/collaborations.html}
\end{itemize}
