...
\begin{document}
\makeheading{Sebastiano Panichella - Top 10 Selected
publications}
...
\section{Top 10 Selected publications that influenced (or are influencing) the research field}:
\begin{enumerate}
{ 
...
\makeheading{Sebastiano Panichella – Complete List of Publications}
